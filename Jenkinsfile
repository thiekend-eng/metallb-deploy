pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/thiekend-eng/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('thiekend-225')   // <---- Change this to match your kubernetes cluster credentials
    }
